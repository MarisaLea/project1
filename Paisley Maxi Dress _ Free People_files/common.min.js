...
this.eventHandlers[a]||(this.eventHandlers[a]=[]);this.eventHandlers[a].push(b)};d.prototype.fireEvent=function(a,b,f){a=this.eventHandlers[a.toLowerCase()];var e=[],c=f;!f||f instanceof Array||(c=[f]);a&&a.forEach(function(g){e.push(g.apply(void 0,c))});return b?b(e):!0};d.prototype.isCommunityOrSite=function(){return window.$A&&"function"===typeof window.$A.get&&window.$A.get("$Site")};d.prototype.loadScriptFromUrl=function(a,b,f){var e=document.createElement("script");e.type="text/javascript";
b&&(e.onload=b);f&&(e.onerror=f);e.src=a;document.body.appendChild(e)};d.prototype.generateResourceUrl=function(a,b){return a+"/resource/"+b};d.prototype.processCustomizations=function(a,b,f){var e;!b.customizations||1>b.customizations.length||(b=b.customizations.filter(function(c){return c.name===a}),(b=0<b.length?b[0]:null)&&b.hasOwnProperty("resources")&&0<b.resources.length?b.resources.forEach(function(c){c&&c.hasOwnProperty("type")&&c.type&&f.hasOwnProperty(c.type)&&"function"===typeof f[c.type]&&
(e=f[c.type],e(c))}):embedded_svc.utils.log("No customizations with code settings name "+a+" found."))};d.prototype.getSiteEndpointUrl=function(a){return a.siteUrl?a.siteUrl:null};window.embedded_svc.utils=new d})();
